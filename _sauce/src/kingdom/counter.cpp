...
char* _limitDestroy = SignatureScan<char*>("\x48\x89\x5C\x24\x08\x57\x48\x83\xEC\x20\x48\x8B\xF9\x8B\x09\xE8\x00\x00\x00\x00\x48\x8B\xC8\xE8", "xxxxxxxxxxxxxxxx????xxxx");
char* _missionCountDestroy = ResolveRelativeAddress<char*>(_limitDestroy, 0xF9);
char* _forceLeaveCounter = ResolveRelativeAddress<char*>(_missionCountDestroy, 0x13); 

void(*dk::COUNTER::forceLeave)(char*) = ResolveRelativeAddress<void(*)(char*)>(_forceLeaveCounter, 0x1B);
