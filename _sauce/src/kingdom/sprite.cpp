...
void (*dk::Sprite::update)(char*) = SignatureScan<void(*)(char*)>("\x40\x53\x48\x83\xEC\x20\x48\x8B\xD9\x8B\x49\x10\x8B\xC1\xC1\xE8", "xxxxxxxxxxxxxxxx");
void (*dk::Sprite::setNum)(char*, int) = SignatureScan<void(*)(char*, int)>("\x40\x53\x48\x83\xEC\x20\x48\x8B\xD9\x89\x91\xD4\x01\x00\x00\x48", "xxxxxxxxxxxxxxxx");
void (*dk::Sprite::setPos)(char*, int, int) = ResolveFunctionFromCall<void(*)(char*, int, int)>("\x48\x89\x5C\x24\x18\x48\x89\x74\x24\x20\x57\x48\x83\xEC\x40\x48\x8B\xF9\x8B\xF2\x48\x83\xC1\x38\xE8\x00\x00\x00\x00\x84\xC0\x00\x00\x39\xB7\xAC\x0D\x00\x00", "xxxxxxxxxxxxxxxxxxxxxxxxx????xx??xxxxxx", 0xBB);
